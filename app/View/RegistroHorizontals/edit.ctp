...
<?php echo $this->Form->create('RegistroHorizontal'); ?>
	<fieldset>
		<legend><?php echo __('Edit Registro Horizontal'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('RegistroHorizontal.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('RegistroHorizontal.id'))); ?></li>
