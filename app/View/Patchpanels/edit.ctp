...
<?php echo $this->Form->create('Patchpanel'); ?>
	<fieldset>
		<legend><?php echo __('Edit Patchpanel'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Patchpanel.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Patchpanel.id'))); ?></li>
