<div class="campuses index">
	...
	<tr>
		...
		<td><?php echo h($campus['Campus']['nombre']); ?>&nbsp;</td>
		<td><?php echo h($campus['Campus']['direccion']); ?>&nbsp;</td>
		<td><?php echo h($campus['Campus']['hora_entrada']); ?>&nbsp;</td>
		<td><?php echo h($campus['Campus']['hora_salida']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $campus['Campus']['id']), array(), __('Are you sure you want to delete # %s?', $campus['Campus']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
